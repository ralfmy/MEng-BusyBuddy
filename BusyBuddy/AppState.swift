...
public class AppState: ObservableObject {
    ...
    @Published var modelSelection: ModelType = ModelType(rawValue: UserDefaults(suiteName: "group.com.zcabrmy.BusyBuddy")!.integer(forKey: "model")) ?? ModelType.classifier_tc
}
