...
//        let placesModel = (UIApplication.shared.delegate as! AppDelegate).placesModel
...
//        let placesView = AppView().environmentObject(appState).environmentObject(placesModel)
//
